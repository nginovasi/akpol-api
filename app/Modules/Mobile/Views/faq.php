  ...
  <div class="glue-header h-c-header h-c-header--corporate-initiative">
    <main id="jump-content" class="sc-main">
      ...
      <span role="text">Bagaimana kami dapat <span class="-no-break"> membantu Anda?</span>
          ...
          <div class="sc-intro__copy"> <span role="text"><p align="justify">Ada pertanyaan tentang Aplikasi SIMPELPOL? Kami merangkum pertanyaan seputar aplikasi SIMPELPOL dengan kategori pertanyaan dibawah ini.<span class="-no-break"> Silahkan cari informasi apa yang anda inginkan, Jika masih mengalami kesulitan silahkan hubungi kami melalui email di <b style="color: blue;">adm.simpelpol@gmail.com<b>.</span>
            </p>
            </span>
          </div>
        </div>
      ...
      <?php 
        ...
        $rs= $this->db->query("SELECT * from prodone_faq_cat");
      ?>
       <?php
                     $rs = $this->db->query("SELECT * from prodone_faq_cat");
                     ...
                     foreach($rs->result() as $items){ $n++;?>

                    
                    
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-<?=$n?>">
                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">


                  <span role="text"><?=$n?>. Pertanyaan Seputar <b><?=$items->kategori?>.</b></span>
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                          <ul>
                             <?php
                     $rs2 = $this->db->query("SELECT * from prodone_faq_content where kat_faq='".$items->id."'");
                  
                    

                     foreach($rs2->result() as $items2){ ?>
                            <li>Q: <?=$items2->Q?> <br>A: <?=$items2->A?></li>
                            <?php }
                              ?>
                          </ul>
                      </div>
