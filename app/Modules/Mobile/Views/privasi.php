              ...
              <div data-glue-responsive-accordion-static data-glue-responsive-accordion-static-breakpoints="['x-small']" class="sc-principles">
                <ol class="sc-principles__list">
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Kami yakin bahwa ide-ide ini tidak terpisahkan. Ide-ide tersebut mewakili satu keyakinan inti yang telah memengaruhi semua produk yang kami buat sejak awal di Aplikasi SIMPEL POL, dan produk yang akan kami buat ke depannya. Saat pengguna menggunakan produk kami, mereka mempercayakan informasinya kepada kami, dan sudah menjadi tugas kami untuk menjaganya. Ini berarti kami selalu bijaksana terkait data yang kami gunakan, cara menggunakan, dan <span class="-no-break">cara melindunginya.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Untuk membantu pengguna mengambil keputusan yang tepat terkait cara mereka menggunakan Aplikasi SIMPEL POL, kami mempermudah pengguna untuk memahami tentang data apa yang kami kumpulkan, cara penggunaan, serta alasannya. Bersikap transparan berarti membuat informasi ini tersedia, dapat dipahami, dan dapat ditindaklanjuti <span class="-no-break">dengan mudah.</span>
                          </span>
                        </p>
                      </div>
                    </div>
                  ...
                  <svg role="img" class="h-c-icon h-c-icon--chevron
                    ...
                    <div class="sc-principles__content">
                      <div class="sc-principles__principle-copy">
                        <p align="justify"> <span role="text">Kami tahu tidak ada satu solusi yang cocok bagi semua pengguna dalam hal privasi. Setiap Akun pada Aplikasi SIMPEL POL dibuat dengan kontrol data aktif/nonaktif, sehingga pengguna kami dapat memilih setelan privasi yang tepat bagi mereka. Dan seiring berkembangnya teknologi, kontrol privasi kami juga berkembang, yang memastikan bahwa privasi selalu dikontrol <span class="-no-break">oleh pengguna.</span>
                          </span>
                        </p>
                      </div>
                    </div>
